...
import { SYN_MINT, SYN_PUMPFUN_URL, SYN_SYMBOL } from "../config/synToken";
    ...
    <div className="page about-page">
      ...
      <section id="syn-roadmap" className="about-page__section marketing-panel about-page__section--roadmap">
        ...
        <p className="about-page__roadmap-note">
          ${SYN_SYMBOL} is live on pump.fun. Tokenomics, treasury routing, and legal availability for other
          jurisdictions will be updated as the ecosystem matures. Nothing here is an offer of securities.
          Mint:{" "}
