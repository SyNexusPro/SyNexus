...
function script({ id, day, format, hook, build, payoff, loop, visualStyle = "default", headline }) {
  ...
  return {
    ...
    loop,
    visualStyle,
    headline: headline || hook.split(".")[0]?.slice(0, 48) || "SCAN ANY TOKEN",
    voiceover,
...
const DAY_1 = [
  ...
  script({ id: "d1-s4", day: 1, format: "ai_detection", visualStyle: "dashboard", headline: "I'M WATCHING", hook: "SyNexus is already watching.", build: "Four Sentinels. One verdict. Risk, momentum, whales — live on Solana.", payoff: "Scan a token. One paste. One answer.", loop: "Move with data. Not hope." }),
...
const DAY_2 = [
  ...
  script({ id: "d2-s3", day: 2, format: "exposed_scam", visualStyle: "glitch", headline: "DESIGNED TO DRAIN", hook: "Most coins are designed to drain you.", build: "The chart won't show it. Sentinels will.", payoff: "Scan a token. Five seconds. One verdict.", loop: "One paste. One verdict. Move." }),
...
const DAY_3 = [
  ...
  script({ id: "d3-s2", day: 3, format: "before_it_happens", visualStyle: "dashboard", headline: "EARLY PATTERNS", hook: "This AI tracks early movement patterns.", build: "Momentum, whale concentration, liquidity drift—fused into one read.", payoff: "Token scan — SyNexus answers before you ape.", loop: "Watch before it happens." }),
...
const DAY_4 = [
  ...
  script({ id: "d4-s4", day: 4, format: "founder_story", visualStyle: "story", headline: "ONE QUESTION", hook: "One question changed how I trade.", build: "Paste any mint. Avoid, Watch, or OK — no maybes.", payoff: "SyNexus gives that answer in seconds.", loop: "Try it today." }),
...
const DAY_7 = [
  ...
  script({ id: "d7-s2", day: 7, format: "ai_detection", visualStyle: "fomo", headline: "TELEGRAM ALERTS", hook: "Private alerts are going into Telegram.", build: "Join the SyNexus channel for launch drops and scan reminders.", payoff: "Token scan free at synexus dot pro.", loop: "Link in bio." }),
